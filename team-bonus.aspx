...
<asp:Content runat="server" ContentPlaceHolderID="ContentArea">
    ...
    <h1>Награды команд</h1>
    <p>Команды, участвующие в играх, могут заработать следующие награды, отображаемые на <a href="http://chtogdekogda.org/results.aspx">странице рейтинга</a>.</p>
        <table class="bonus-table">
            <tr>
                <td style="width:130px">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 297 297" width="100" fill="#a53a00">
                ...
                <td>
                    ...
                    <div class="bonus-descr">
                        Награждается команда, которая достигла рекордного значения рейтинга среди всех команд. Текущий рейтинг команды при этом не обязательно должен быть высоким. Эта награда означает, что команда побила клубный рекорд когда-либо в истории клуба.
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100" viewBox="0 0 31.323 31.322" xml:space="preserve">
                ...
                <td>
                    <div class="bonus-title">
                        Большая Филадельфийская Сова
                    </div>
                    <div class="bonus-descr">
                        Эта команда сейчас удерживает Большую Филадельфийскую Сову - переходящий приз нашего клуба. На ближайшей игре этот приз перейдет к команде с наивысшим рейтингом (команде под номером 1 на странице рейтинга).
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 511.269 511.269" width="100">
                ...
                <td>
                    ...
                    <div class="bonus-descr">
                        Этот приз вручается команде, рейтинг которой в настоящий момент достиг пикового значения. Другими словами, команда сейчас играет лучше, чем когда-либо за свою историю.
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                 <svg version="1.1" width="100" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="green" viewBox="0 0 539.077 539.077">
                ...
                <td>
                    ...
                    <div class="bonus-descr">
                        Этот приз вручается команде, которая рассказала о себе на своей страничке. Каждый теперь может почитать про историю команды, об участниках, названии и т.п. а может даже посмотреть фотографии команды из фотогаллереи. Просто нажмите на название команды на странице рейтинга, чтобы перейти на персональную страницу команды.
                    </div>
                </td>
            </tr>
